...
def main
  ...
  homebrew_install_brew("dasht")
  homebrew_install_brew("hub")
  homebrew_install_brew("git")
  homebrew_install_brew("gitsh")
  ...
  homebrew_install_cask("mplayerx")
  ...
  run("dasht-docsets-install --force Bourbon")
  run("dasht-docsets-install --force CSS")
  run("dasht-docsets-install --force Chai")
  run("dasht-docsets-install --force D3JS")
  run("dasht-docsets-install --force Elixir")
  run("dasht-docsets-install --force HTML")
  run("dasht-docsets-install --force JavaScript")
  run("dasht-docsets-install --force Mocha")
  run("dasht-docsets-install --force MySQL")
  run("dasht-docsets-install --force Neat")
  run("dasht-docsets-install --force PostgreSQL")
  run("dasht-docsets-install --force Ruby_2")
  run("dasht-docsets-install --force Ruby_on_Rails_3")
  run("dasht-docsets-install --force Ruby_on_Rails_4")
  run("dasht-docsets-install --force Ruby_on_Rails_5")
  run("dasht-docsets-install --force Sass")
  run("dasht-docsets-install --force Sinon")
  run("dasht-docsets-install --force jQuery")
  run("dasht-docsets-install --force jQuery_UI")
end
